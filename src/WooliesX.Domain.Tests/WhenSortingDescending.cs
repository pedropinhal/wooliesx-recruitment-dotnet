...
{
    [TestFixture]
    public class WhenSortingDescending
    {
        ...
        public async Task Setup()
        {
            ...
            _sortResponse = await handler.Handle(new GetSortRequest { SortOption = "Descending" }, CancellationToken.None);
        }
        ...
        {
            Assert.That(_sortResponse.Products[0].Name, Is.EqualTo("Zucchini"));
            Assert.That(_sortResponse.Products[1].Name, Is.EqualTo("Orange"));
            Assert.That(_sortResponse.Products[2].Name, Is.EqualTo("Banana"));
            Assert.That(_sortResponse.Products[3].Name, Is.EqualTo("Apple"));
        }
